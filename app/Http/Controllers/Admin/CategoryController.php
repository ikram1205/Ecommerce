...
class CategoryController extends Controller
{
   ...
   {
      return view('backend.home.admin.category.create');
   }
   ...
   public function categoryManage()
   {
       ...
       return view('backend.home.admin.category.list', compact('categories'));
   ...
   public function categoryEdit($id)
   {
        ...
        return view('backend.home.admin.category.edit', compact('category'));
   }
